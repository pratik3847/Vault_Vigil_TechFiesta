              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Analyze an unknown URL using frontend-only heuristics, then review risk score, decision, and explanation.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="flex items-center justify-between gap-3">
                    <div className="text-sm text-muted-foreground">
                      Starts at: <span className="font-medium text-foreground">Scam Link Detection</span>
                    </div>
