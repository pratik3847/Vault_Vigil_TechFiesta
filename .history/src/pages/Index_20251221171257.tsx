        ...
        <div className="container px-4">
          <div className="mx-auto max-w-3xl text-center mb-12">
            ...
            <p className="text-muted-foreground">
              Our AI-powered system follows a comprehensive 4-stage pipeline to detect and prevent fraud in real-time
            </p>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-4 mb-8">
            <div className="glass-card p-6 relative">
              <div className="absolute -top-3 -left-3 h-10 w-10 rounded-full bg-primary flex items-center justify-center text-white font-bold">1</div>
              <Activity className="h-8 w-8 text-primary mb-3 mt-4" />
              <h3 className="font-semibold mb-2">Transaction Input</h3>
              <p className="text-sm text-muted-foreground">Generate or simulate normal and fraudulent transactions with realistic patterns</p>
            </div>
            <div className="hidden md:flex items-center justify-center">
              <ArrowRight className="h-6 w-6 text-primary" />
            </div>
            <div className="glass-card p-6 relative">
              <div className="absolute -top-3 -left-3 h-10 w-10 rounded-full bg-primary flex items-center justify-center text-white font-bold">2</div>
              <Network className="h-8 w-8 text-primary mb-3 mt-4" />
              <h3 className="font-semibold mb-2">Link Analysis</h3>
              <p className="text-sm text-muted-foreground">Detect suspicious patterns through shared devices, IPs, and circular transfers</p>
            </div>
            <div className="hidden md:flex items-center justify-center">
              <ArrowRight className="h-6 w-6 text-primary" />
            </div>
            <div className="glass-card p-6 relative">
              <div className="absolute -top-3 -left-3 h-10 w-10 rounded-full bg-primary flex items-center justify-center text-white font-bold">3</div>
              <Gauge className="h-8 w-8 text-primary mb-3 mt-4" />
              <h3 className="font-semibold mb-2">Risk Scoring</h3>
              <p className="text-sm text-muted-foreground">Multi-factor risk assessment combining transaction and network analysis</p>
            </div>
            <div className="hidden md:flex items-center justify-center">
              <ArrowRight className="h-6 w-6 text-primary" />
            </div>
            <div className="glass-card p-6 relative">
              <div className="absolute -top-3 -left-3 h-10 w-10 rounded-full bg-primary flex items-center justify-center text-white font-bold">4</div>
              <Scale className="h-8 w-8 text-primary mb-3 mt-4" />
              <h3 className="font-semibold mb-2">Final Decision</h3>
              <p className="text-sm text-muted-foreground">Automated decision: Allow, Alert, or Block with transparent reasoning</p>
            </div>
          </div>
        </div>
      </section>
