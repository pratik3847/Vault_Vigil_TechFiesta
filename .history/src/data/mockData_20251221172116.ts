...
/**
 * NETWORK GRAPH DATA
 * Used for Link Analysis visualization
 * Shows fraud pattern: ACC-9012 and ACC-3456 share device DEV-C3D4 and IP 10.0.0.55
 * This creates a high-risk fraud chain that should be flagged
 */
...
/**
 * RISK FACTORS
 * Individual fraud indicators with severity levels and score contributions
 */
 ...
 * Creates realistic mock transactions with fraud patterns
 * 
 * Normal Pattern:
 * - Amount: $100 - $5,000
 * - Locations: Major trusted cities
 * - Unique device IDs
 * - Private IP addresses
 * 
 * Fraud Pattern:
 * - Amount: $10,000 - $60,000 (unusually high)
 * - Locations: High-risk countries or "Unknown"
 * - Shared/suspicious device ID
 * - Same IP address (10.0.0.55) as known fraud accounts
 * - Risk score 70-100
 */
